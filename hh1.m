function [V,m,h,n,t] = hh1(I,tspan, v, mi, hi, ni,Plot)   
%   This function simulates the Hodgkin-Huxley model for user specified input
%   current.
%  
%   hh1(I,tspan,V,m,h,n,Plot) function simulates the Hodgkin-Huxley model 
...
%   Example 1 -
%   
%   hh1(0.1, 1000, -65, 0.5, 0.06, 0.5,1)
%              1000 ms = 1 sec
%   hh1(0.1, 10000, -65, 0.5, 0.06, 0.5,1)
%              10000 ms = 10 sec
%
%   hh1(0.2, 500, -65, 0.5, 0.06, 0.5,1)
%   hh1(0.1, 500, -65, 0.5, 0.06, 0.5,1)
%   where,
...
%
%   Example 2 -
%   [V,m,h,n,t] = hh1(0.08, 200, -65, 0.4, 0.2, 0.5,0);
